public class PhraseOMatic {
	public static void main (String[] args) {
		...
		String[] wordListOne = {"24/7", "várias camadas", "30.000 pes", "B-to-B", "todos ganham", "front-end", "baseado na web", "difundido", "inteligente", "seis sigma", "caminho crítico", "dinâmico"};
